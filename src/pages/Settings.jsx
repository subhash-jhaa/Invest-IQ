...
export default function Settings() {
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      disabled={updating}
                      className="px-3 py-1 bg-emerald-500 text-white rounded hover:bg-emerald-500 disabled:opacity-50"
                    >
                      Save
                    </button>
                    <button
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-lg shadow-lg p-6 mb-8">
